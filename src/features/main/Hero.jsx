  ...
  return (
    <section className="min-h-[80vh] bg-cover bg-center bg-no-repeat">
      <div className="mx-auto flex max-w-7xl flex-col-reverse items-center justify-between gap-8 px-4 py-10 sm:flex-row sm:px-8 lg:px-20">
        {/* Text Section */}
        <div className="flex flex-1 flex-col items-start gap-6 text-left text-sm text-stone-700 sm:text-lg md:text-xl">
        ...
        <div className="flex flex-1 justify-center">
          <img
            ...
            className="w-full max-w-[400px] rounded-md object-cover shadow-lg sm:max-w-[500px] md:max-w-[600px]"
          />
        </div>
      </div>
    </section>
